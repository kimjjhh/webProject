...
String[] hobby2 = request.getParameterValues("hobby2"); //checkbox
String hobby3 = request.getParameter("hobby3"); //select..1
String[] hobby4 = request.getParameterValues("hobby4"); //select..2
